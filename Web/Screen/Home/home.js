...
$.get("/Web/Screen/Home/Section_1/Section_1.html", function (data) {
  $("Section1").html(data);
});
$.get("/Web/Screen/Home/Section_2/Section_2.html", function (data) {
  $("Section2").html(data);
});
$.get("/Web/Screen/Home/Section_3/Section_3.html", function (data) {
  $("Section3").html(data);
});
$.get("/Web/Screen/Home/Section_4/Section_4.html", function (data) {
  $("Section4").html(data);
});
